...
public class SeleniumTestScenario4M {
WebDriver driver=null;
	...
	public void registrationForm1TC2(String name, String xpath)
	{
		/*System.setProperty("webdriver.chrome.driver", "D:\\Lib\\chromedriver.exe");
		driver = new ChromeDriver();
		driver.get("https://seleniumqtpautomation.000webhostapp.com/final.html");*/
	/*	String str= driver.findElement(By.xpath("//input[@name='name']")).getAttribute(xpath);
